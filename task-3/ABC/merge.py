...
file1 = pd.read_csv('updatedA1 .csv')
...
# file1.to_csv('updatedC3FilterEmail.csv',index = False)
for i in  li: #file2['Email'].values.tolist():
...
file1.to_csv('updatedA1 .csv',index = False)

...
# df = pd.read_csv(f'coin_gecko_link.csv')

# x =  len(df)//100
# print(x)

# driver.maximize_window()
# for page in range(x,127):
#     try:
#         lis = []
#         link = f'https://www.coingecko.com/?page={page}'
#         print(page)
#         driver.get(link)
#         time.sleep(3)
...
#             li = driver.find_elements(By.XPATH,"//a[@class='tw-flex tw-items-center tw-w-full']")
...
#         print(len(df))
#         df.to_csv('coin_gecko_link.csv',index=False,mode='a',header=False)
#     except:
#         print('error')
